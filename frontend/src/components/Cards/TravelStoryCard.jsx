...
const TravelStoryCard = ({
    ...
    return (
        <div className='border rounded-lg overflow-hidden bg-white hover:shadow-lg hover:shadow-slate-200 translate-all ease-in-out relative cursor-pointer'>
            ...
            <div className='p-4' onClick={onClick}><div className='flex items-center gap'><div className='flex-1'>
