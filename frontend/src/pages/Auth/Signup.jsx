    ...
    <div className='h-screen bg-cyan-50 overflow-hidden relative'>
      ...
      <div>
        ...
        <p className='text-[15px] text-white leading-6 pr-7 mt-4'>
          Create an account and start preserving your travel memories.
        </p>
        </div>
      </div>  
      ...
      <form onSubmit={handleSignup}>
        ...
        <input type="text" placeholder='Full Name' className='input-box' value={name} onChange={
          ({target})=>{
            setName(target.value)
          }
        }/>

        <input type="text" placeholder='Email' className='input-box' value={email} onChange={
          ({target})=>{
